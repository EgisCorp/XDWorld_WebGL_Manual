...
## look\([JSVector3D](../core/jsvector3d.md) from, [JSVector3D](../core/jsvector3d.md) to\) → boolean
...
## move\([JSVector3D](../core/jsvector3d.md) VecLocation, number tilt, number direct, number speed\)
...
## moveLonLatBoundarybyJson\(object parameter\) → string
...
## moveOval\([JSVector3D](../core/jsvector3d.md) VecLocation, number tilt, number direct, number speed\)
...
## setLocation\([JSVector3D](../core/jsvector3d.md) VecLocation\) → boolean
...
## setAutoMoveRoundPositions\([JSVector3D](../core/jsvector3d.md) center, number distanceFromCenter, number cameraAltitude, number roundStartAngle, number roundEndAngle, boolean clockWise\) → boolean
