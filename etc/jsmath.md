...
### convertBezierCurve(options) → [JSVec3Array](https://github.com/EgisCorp/XDWorld_WebGL_Manual/blob/master/core/JSVec3Array.md)
...
* Return
  * [JSVec3Array](https://github.com/EgisCorp/XDWorld_WebGL_Manual/blob/master/core/JSVec3Array.md): 변환 성공
  * size 0: 변환 실패.
* Sample
  * function createCurvedLine 참조.
  * [Sandbox\_LineInterpolation(Curved)](https://sandbox.egiscloud.com/code/main.do?id=object_line_interpolate_curved)
{% endtab %}
...
* Sample
  ...
  * [Sandbox\_ParabolicLine](https://sandbox.egiscloud.com/code/main.do?id=object_line_arc)
{% endtab %}
...
* Return
  ...
  * `.return`: `{ length, count, data }` 객체 반환
    * `length`: 전체 거리 (meter)
    * `count`: 좌표 개수
    * `data`: [JSVec3Array](https://github.com/EgisCorp/XDWorld_WebGL_Manual/blob/master/core/JSVec3Array.md) 형태의 분할 좌표
{% endtab %}
...
* Sample
  ...
  * [Sandbox\_Object Indicator](https://sandbox.egiscloud.com/code/main.do?id=coordinate_indicator)
{% endtab %}
...
| Name       | Type   | Attributes | Default | Description                                                             |
| ---------- | ------ | ---------- | ------- | ----------------------------------------------------------------------- |
| type       | string |            |         | 경사분석 옵션(TERRAIN\_ANGLE, TERRAIN\_DIRECTION, TERRAIN\_DIRECTION\_ANGLE). |
