...
> * bool setModelFaceReflect(string id, unsigned int face\_index, float reflect)
> * Class : JSGhostSymbolMap
> * Parameter
>   * id : 모델 ID
>   * face\_index : 효과를 적용할 face 인덱스
...
> * MML\_RETURN\_ANALYSISPOS 마우스모드 랜더링 오류 수정
...
> * JSPoint property z\_index 기능 추가 완료
...
>   * JSPoint에 이미지 스케일 설정을 위한 프로퍼티 image\_scale이 추가되었습니다.
